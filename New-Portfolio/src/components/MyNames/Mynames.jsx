    ...
    return (
        <div
            ...
            <div id="col1" className="md:h-screen h-screen flex-1 flex flex-col justify-center lg:pl-10 text-lg-start text-md-center text-center text-white">
                ...
                <h className="text-7xl lg:text-7xl font-dmserif pt-1 pb-2">
                I'm Christian <br /> P. Pitao
                </h>
                <h className="text-2xl pt-2 pb-3 lg:text-4xl font-bold font-playfair text-red-600">
                - Aspiring Junior Developer
                </h>
                <p className="lg:text-base text-sm pt-3 pb-2 font-medium italic font-roboto tracking-wide lg:max-w-2xl text-md-justify text-justify px-lg-0 px-md-5 px-4">
            ...
            <div id="col2" className="h-screen flex-1 flex flex-col lg:items-end items-center justify-center lg:pr-10">
                <div className='flex lg:flex-row flex-col lg:pt-3 lg:pb-3 my-2 lg:my-0' >
                    <div className='flex flex-col justify-center lg:items-end item-start lg:pr-10 text-center'>
                        <h className='text-white font-lora text-3xl font-semibold'>Web Development</h>
                ...
                <div className='flex lg:flex-row flex-col lg:pt-3 lg:pb-3 my-2 lg:my-0' >
                    <div className='flex flex-col justify-center lg:items-end item-start lg:pr-10 text-center'>
                        <h className='text-white font-lora text-3xl font-semibold'>Software Development</h>
                ...
                <div className='flex lg:flex-row flex-col lg:pt-3 lg:pb-3 my-2 lg:my-0' >
                    <div className='flex flex-col justify-center lg:items-end item-start lg:pr-10 text-center'>
                        <h className='text-white font-lora text-3xl font-semibold'>Application Development</h>
