                ...
                <form ref={form} id="FillupForm" onSubmit={sendEmail} className='lg:w-2xl w-8/10 
                    ...
                    <div id='Email-Phone-box' className='flex flex-row'>
                        <div id='Email' className='flex flex-1 flex-col mr-2'>
                            ...
                            <input id='EmailIn' className='w-full h-10 text-sm placeholder:text-sm rounded-md bg-gray-700 pl-3' type="email" name="user_email" placeholder="Enter Email" required />
                        </div>

                        <div id='Phone' className=' flex flex-1 flex-col'>
                            <p className=' my-3'>Phone Number</p>
                            <input id='PhoneIn' className='w-full h-10 text-sm placeholder:text-sm rounded-md bg-gray-700 pl-3' type="tel" name="user_phone" placeholder="Enter Phone Number" required />
                        </div>
                    </div>
                    <p className=' my-3'>Message</p>
                    <textarea id='TextAreaIn' className='w-full h-60 text-sm placeholder:text-sm rounded-md bg-gray-700 pl-3 pt-1' name="message" placeholder="Enter Message" required></textarea>
            ...
            <div id='ContactDetails' className='lg:flex lg:flex-1 lg:items-center content-center justify-center w-screen h-screen'>
                <div id='ContactDetailsBox' className='lg:w-2xl'>
                    <header id='ContactUsBox' className='lg:flex lg:flex-row 
                                                         ...
                                                         lg:text-7xl text-6xl font-mozilla-headline-bold
                                                         my-4'>
                        <h className=''>Contact&nbsp;</h>
                        <h id='h1white' className='text-teal-300'>Us</h> 
                    </header>
                    <p id='forquestion' className='lg:w-9/10 w-9/10 justify-self-center font-mozilla-headline-extralight text-center lg:text-xl text-sm lg:justify-self-center'>
                    ...
                    <div id='ContactInfo' className='lg:w-9/10 w-9/10 justify-self-center'>
                        <div id='PhoneIcon' className='flex flex-row my-10'>
                            <div id='phoneIconContainer' className='lg:w-15 lg:h-15 w-12 h-12 rounded-full mr-5 flex items-center justify-center bg-teal-300'>
                                <img src={phoneIcon} alt="phoneIcon" className='lg:w-10 lg:h-10 w-8 h-8'/>
                            </div>
                            <p className='flex items-center m-0  lg:text-2xl font-mozilla-headline '>+63 956 8369 352</p>
                        </div>
                        <div id='EmailIcon' className='flex flex-row items-center my-10'>
                            <div id='emailIconContainer' className='lg:w-15 lg:h-15 w-12 h-12 rounded-full mr-5
                                                                    justify-items-center content-center 
                                                                    bg-teal-300 '>
                                <img src={emailIcon} alt="emailIcon" className='lg:w-10 lg:h-10 w-8 h-8'/>
                            </div>
                            <p id='Email' className='flex items-center m-0  lg:text-2xl font-mozilla-headline '> Christianpitao07@gmail.com</p>
                        </div>
                        <div id='AddressIcon' className='flex flex-row items-center my-10 '>
                            <div id='addressIconContainer' className='lg:w-15 lg:h-15 w-12 h-12 rounded-full mr-5
                                                                      justify-items-center content-center 
                                                                      bg-teal-300 '>
                                <img src={addressIcon} alt="addressIcon" className='lg:w-10 lg:h-10 w-8 h-8'/>
                            </div>
                            <p id='Address' className='flex items-center m-0 
                                                       w-8/10
                                                       lg:text-2xl font-mozilla-headline text-start 
                                                       '>
